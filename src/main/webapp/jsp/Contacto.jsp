    		...
    		<div class="row">
	    		<div class="col-sm-8">
	    			<div class="contact-form">
                        <s:form id="Contacto" method="Post" action="VerificarFormulario">
			                <div class="form-group col-md-6">
                                <s:textfield class="form-control" name="Mail.mombreContacto" label="Nombre"/>
                            </div>
		                    <div class="form-group col-md-6">
                                <s:textfield class="form-control" name="Mail.asunto" label="Asunto"/>
                            </div>
    	    	            <div class="form-group col-md-6">
                                <s:textarea class="form-control" name="Mail.cuerpoMail" label="Comentarios"/>
                            </div>
                            <div class="form-group col-md-6">
